...
*/
#ifndef NVIDIA_ISAAC_EXTENSIONS_GXF_OPTIMIZER_CORE_OPTIMIZER_HPP_
#define NVIDIA_ISAAC_EXTENSIONS_GXF_OPTIMIZER_CORE_OPTIMIZER_HPP_
...
#endif  // NVIDIA_ISAAC_EXTENSIONS_GXF_OPTIMIZER_CORE_OPTIMIZER_HPP_
