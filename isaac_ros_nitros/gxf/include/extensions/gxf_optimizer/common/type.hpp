...
*/
#ifndef NVIDIA_ISAAC_EXTENSIONS_GXF_OPTIMIZER_COMMON_TYPE_HPP_
#define NVIDIA_ISAAC_EXTENSIONS_GXF_OPTIMIZER_COMMON_TYPE_HPP_
...
#endif  // NVIDIA_ISAAC_EXTENSIONS_GXF_OPTIMIZER_COMMON_TYPE_HPP_
