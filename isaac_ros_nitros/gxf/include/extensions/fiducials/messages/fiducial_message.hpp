...
*/
#ifndef NVIDIA_ISAAC_EXTENSIONS_FIDUCIALS_MESSAGES_FIDUCIAL_MESSAGE_HPP_
#define NVIDIA_ISAAC_EXTENSIONS_FIDUCIALS_MESSAGES_FIDUCIAL_MESSAGE_HPP_
...
// Message entity is activated by default
gxf::Expected<FiducialListMessageParts> CreateFiducialListMessage(gxf_context_t context,
                                                                  size_t count,
                                                                  bool activate = true);
...
#endif  // NVIDIA_ISAAC_EXTENSIONS_FIDUCIALS_MESSAGES_FIDUCIAL_MESSAGE_HPP_
