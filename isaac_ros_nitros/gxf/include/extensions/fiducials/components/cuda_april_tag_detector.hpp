...
*/
#ifndef NVIDIA_ISAAC_EXTENSIONS_FIDUCIALS_COMPONENTS_CUDA_APRIL_TAG_DETECTOR_HPP_
#define NVIDIA_ISAAC_EXTENSIONS_FIDUCIALS_COMPONENTS_CUDA_APRIL_TAG_DETECTOR_HPP_
...
class CudaAprilTagDetector : public gxf::Codelet {
 ...
 private:
  ...
  gxf::Expected<void> createAprilTagDetector(const ::isaac::geometry::PinholeD& intrinsics_info);
...
#endif  // NVIDIA_ISAAC_EXTENSIONS_FIDUCIALS_COMPONENTS_CUDA_APRIL_TAG_DETECTOR_HPP_
