  ...
  ros_message_type & destination)
{
  ...
  auto gxf_message = nvidia::gxf::Entity::Shared(
    nvidia::isaac_ros::nitros::g_type_adapter_nitros_context.getContext(), source.handle);
  if (!gxf_message) {
  ...
  custom_type & destination)
{
  ...
  auto gxf_message = nvidia::gxf::Entity::New(
