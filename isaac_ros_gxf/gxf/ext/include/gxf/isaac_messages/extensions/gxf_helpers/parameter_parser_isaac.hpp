...
struct ParameterParser<::nvidia::isaac::Vector<T, N>> {
  static Expected<::nvidia::isaac::Vector<T, N>> Parse(
...
struct ParameterParser<::nvidia::isaac::Matrix<T, N, M>> {
  static Expected<::nvidia::isaac::Matrix<T, N, M>> Parse(
      gxf_context_t context, gxf_uid_t component_uid,
      const char* key, const YAML::Node& node,
      const std::string& prefix) {
...
struct ParameterParser<::nvidia::isaac::Pose2<T>> {
  static Expected<::nvidia::isaac::Pose2<T>> Parse(gxf_context_t context, gxf_uid_t component_uid,
                                           const char* key, const YAML::Node& node,
                                           const std::string& prefix) {
    if (!node.IsMap()) {
      return Unexpected{GXF_PARAMETER_PARSER_ERROR};
...
struct ParameterParser<::nvidia::isaac::Pose3<T>> {
  static Expected<::nvidia::isaac::Pose3<T>> Parse(gxf_context_t context, gxf_uid_t component_uid,
                                           const char* key, const YAML::Node& node,
                                           const std::string& prefix) {
    if (!node.IsMap()) {
      return Unexpected{GXF_PARAMETER_PARSER_ERROR};
...
struct ParameterParser<::nvidia::isaac::geometry::NSphere<T, N>> {
  static Expected<::nvidia::isaac::geometry::NSphere<T, N>> Parse(
      gxf_context_t context, gxf_uid_t component_uid,
...
struct ParameterParser<::nvidia::isaac::geometry::NCuboid<T, N>> {
  static Expected<::nvidia::isaac::geometry::NCuboid<T, N>> Parse(gxf_context_t context,
...
struct ParameterParser<::nvidia::isaac::geometry::Polygon2<T>> {
  static Expected<::nvidia::isaac::geometry::Polygon2<T>> Parse(gxf_context_t context,
    gxf_uid_t component_uid, const char* key, const YAML::Node& node, const std::string& prefix) {
...
struct ParameterParser<::nvidia::isaac::geometry::LineSegment<T, N>> {
  static Expected<::nvidia::isaac::geometry::LineSegment<T, N>> Parse(gxf_context_t context,
    gxf_uid_t component_uid, const char* key, const YAML::Node& node, const std::string& prefix) {
...
struct ParameterParser<::nvidia::isaac::Uuid> {
  static Expected<::nvidia::isaac::Uuid> Parse(
