...
*/
#ifndef EXTENSIONS__DETECTNET__DETECTION2_D_ARRAY_MESSAGE_HPP_
#define EXTENSIONS__DETECTNET__DETECTION2_D_ARRAY_MESSAGE_HPP_
...
{
  gxf::Entity message;
  gxf::Handle<std::vector<nvidia::isaac_ros::Detection2D>> detection2_d_array;
...
#endif  // EXTENSIONS__DETECTNET__DETECTION2_D_ARRAY_MESSAGE_HPP_
