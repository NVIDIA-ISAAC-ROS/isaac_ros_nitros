...
constexpr char PACKAGE_NAME[] = "isaac_ros_nitros_april_tag_detection_array_type";
constexpr char FORWARD_FORMAT[] = "nitros_april_tag_detection_array";

#pragma GCC diagnostic push
#pragma GCC diagnostic ignored "-Wpedantic"
class NitrosAprilTagDetectionArrayForwardNode : public NitrosNode
{
public:
  explicit NitrosAprilTagDetectionArrayForwardNode(const rclcpp::NodeOptions & options)
  : NitrosNode(
      options,
...
RCLCPP_COMPONENTS_REGISTER_NODE(nvidia::isaac_ros::nitros::NitrosAprilTagDetectionArrayForwardNode)
